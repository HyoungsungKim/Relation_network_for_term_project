...
def main():
    ...
    for test in range(20):
        ...
        for episode in range(600):
            total_reward = 0
            task = tg.MiniImagenetTask(metatest_character_folders, CLASS_NUM, SAMPLE_NUM_PER_CLASS, 500)
        ...
        print(f"test result : {test_accuracy:.4f}, h : {h:.4f} ")
        
        mean_accuracy_list.append(test_accuracy)
    ...
    '''
    final_accuracy, h = mean_confidence_interval(mean_accuracy_list)
