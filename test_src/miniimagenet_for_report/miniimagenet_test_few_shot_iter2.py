...
def main():
    ...
    for test in range(5):
        ...
        for i in range(600):
            ...
            test_dataloader = tg.get_mini_imagenet_data_loader(task, num_per_class=number_of_query_image, split="test", shuffle=False)
            ...
            for test_images, test_labels in test_dataloader:
                ...
                rewards = [1 if predict_labels[j] == test_labels[j] else 0 for j in range(CLASS_NUM * 5)]
